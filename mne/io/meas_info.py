...
def _read_dig_fif(*args, **kwargs):
    from mne.channels.digitization._utils import _read_dig_fif as xx
    return xx(*args, **kwargs)


def write_dig(*args, **kwargs):
    from mne.channels.digitization._utils import write_dig as xx
    return xx(*args, **kwargs)


def _read_dig_points(*args, **kwargs):
    from mne.channels.digitization._utils import _read_dig_points as xx
    return xx(*args, **kwargs)


def _write_dig_points(*args, **kwargs):
    from mne.channels.digitization._utils import _write_dig_points as xx
    return xx(*args, **kwargs)


def _make_dig_points(*args, **kwargs):
    from mne.channels.digitization._utils import _make_dig_points as xx
    return xx(*args, **kwargs)
...
class Info(dict):
    ...
    * ``dig`` list:
        ...
        See :class:`~mne.channels.DigPoint`.
